...
export default function NotificationsScreen() {
  ...
  const { notificationsEnabled: enabled, setNotificationsEnabled: setEnabled, healthAlerts, setHealthAlerts } = useSettings();
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.row}>
        <View style={{ flex: 1 }}>
          ...
          <Text style={styles.description}>Receive all app notifications</Text>
        </View>
      ...
      <View style={styles.row}>
        <View style={{ flex: 1 }}>
          ...
          <Text style={styles.description}>Get notified about abnormal health metrics</Text>
        </View>
